    ...
    <div className="p-4 w-full">
      ...
      <div className="mt-3">
        ...
        <h3 className="text-[15px] font-medium">
          <span className="font-[Inter]">5</span> - bedroom house for sale at
        </h3>
        ...
        <div className="mt-4 space-y-2 text-black text-[15px]">
          <p className="flex items-center gap-2">
            <Bed className="w-6 h-6"/> <span className="font-[Inter]">5</span> - bedrooms
          </p>
          <p className="flex items-center gap-2">
            <Bath className="w-6 h-6"/> <span className="font-[Inter]">5</span> - bathrooms
          </p>
          <p className="flex items-center gap-2">
            <Toilet className="w-6 h-6"/> <span className="font-[Inter]">5</span> - water closets
          </p>
        </div>
      </div>
    </div>
