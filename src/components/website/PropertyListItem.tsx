    ...
    <div className="container mx-auto">
      ...
      <div className="relative group">
        <img
          src={propertyImg} 
          alt="House for Sale"
          className="w-full aspect-square object-cover rounded-lg hover:scale-110 cursor-pointer hover:rounded hover:z-100 transition duration-150"
        />
      ...
      <div className="mt-3">
        ...
        <h3 className="text-[15px] font-medium inline-flex">
          <div className="">
            <span className="font-[Inter]">5</span>  <span className=""> - bedroom house for sale </span>
          </div>
