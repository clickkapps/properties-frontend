...
const SignIn = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 shadow-md w-[500px]">
        ...
        {/* Sign-In OPtions */}
        <button className="flex items-center w-full border border-gray-300 rounded-lg py-3 px-4 mb-4 hover:bg-gray-100 relative">
          <img
            src={googleLogo}
            alt="Google Logo"
        ...
        <button className="flex items-center w-full border border-gray-300 rounded-lg py-3 px-4 hover:bg-gray-100 relative">
          <img
            src={emailLogo}
            alt="Email Logo"
            className="w-6 h-6 absolute left-4"
